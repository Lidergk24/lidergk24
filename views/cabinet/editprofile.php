   ...
   <div class="container">
      ...
      <div class="main-cabinet-user__content">
         <ul class="breadcrumb breadcrumb-cabinet">
            ...
            <li><a><span>Редактирование профиля: <?php echo $editUserProfileOne['fiz_fio']; ?></span></a></li>
         </ul>
         ...
         <form method="post" class="form-cabinet">
            <div class="form-group">
               ...
               <input type="text" name="fio" placeholder="Укажите ФИО" value="<?php echo $editUserProfileOne['fiz_fio']; ?>" required autocomplete="off">
               </label>
               <label>
               <span class="form-group__title">Телефон*</span>
               <input type="text" name="phone_fiz" placeholder="+7 (___) ___ - __ - __" id="online_phone" value="<?php echo $editUserProfileOne['fiz_phone']; ?>" autocomplete="off">
               </label>
            </div>
            <div class="form-group">
               <label>
               <span class="form-group__title">E-mail*</span>
               <input type="text" name="emailfiz" placeholder="Укажите Email" value="<?php echo $editUserProfileOne['fiz_email']; ?>" autocomplete="off">
               </label>
               <label>
               <span class="form-group__title">Адрес доставки*</span>
               <input type="text" name="adress_deleviry" placeholder="Адрес доставки" value="<!--?php echo $editUserProfileOne['fiz_adress']; ?>"-->
               </label>
            </div>
            <div class="w-100">
