   ...
   <div class="container">
      ...
      <div class="main-cabinet-user__content">
         <ul class="breadcrumb breadcrumb-cabinet">
            ...
            <li><a><span>Редактирование реквизитов: <?php echo $editUserProfileOneUr['ur_profile']; ?></span></a></li>
         </ul>
         <h1>Редактирование реквизитов: <?php echo $editUserProfileOneUr['ur_profile']; ?></h1>
         ...
         <form method="post" class="form-cabinet">
            <div class="form-group">
               ...
               <input type="text" name="name_profile" placeholder="Придумайте название компании" value="<?php echo $editUserProfileOneUr['ur_profile']; ?>" required>
               </label>
               <label>
               <span class="form-group__title">Форма юр. собственности*</span>
               <select type="text" name="property" placeholder="Укажите форму юридической собственности компании" value="<?php echo $editUserProfileOneUr['property']; ?>" required>
               ...
               <input type="text" name="inn" placeholder="Введите ИНН компании (10 цифр)" maxlength="10" value="<?php echo $editUserProfileOneUr['ur_inn']; ?>" required>
               </label>
            </div>
            <div class="form-group">
               <label>
               <span class="form-group__title">Контактное лицо*</span>
               <input type="text" name="name" placeholder="ФИО контактного лица" value="<?php echo $editUserProfileOneUr['ur_contact']; ?>">
               </label>
               <label>
               <span class="form-group__title">E-mail*</span>
               <input type="text" name="email" placeholder="Укажите Email" value="<?php echo $editUserProfileOneUr['ur_email']; ?>" required>
               </label>
               <label>
               <span class="form-group__title">Телефон*</span>
               <input type="text" name="phone" id="online_phone" placeholder="+7 (___) ___ - __ - __" autocomplete="off" value="<?php echo $editUserProfileOneUr['ur_phone']; ?>" required>
               </label>
            </div>
            <div class="w-100">
