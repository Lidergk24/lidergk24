...
$managerBase =  mysqli_query($con, "SELECT * FROM `Manager` order by manager_name ASC");

if (isset($_POST['search'])) {

    $ajax = $_POST['search'];
    $query = mysqli_query($con, "SELECT * from product_order where order_number=$ajax");
    if ($query->num_rows > 0) { ?>
...
<script src="/template/js/environment.php"></script>
