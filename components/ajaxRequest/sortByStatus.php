...
$sortByStatus = $_POST['sortStatus'];
$environment = include_once($_SERVER['DOCUMENT_ROOT'] . '/config/environment.php');
$sqlDate = mysqli_query($con, "SELECT * from product_order where order_status ='$sortByStatus' order by id DESC limit 50");
...
<script defer src="/template/js/OrderSorting.js"></script>
